...
<div class="grid gap-8 lg:grid-cols-[1fr_320px]">
    <section class="space-y-6 rounded-3xl border border-white/10 bg-[#13121A]/90 p-4 shadow-lg shadow-black/20">
        <div>
            <h1 class="text-2xl font-extrabold"><?php echo sanitize_input($profile['name']); ?></h1>
        ...
        <div>
            <h2 class="mb-3 text-lg font-semibold">Bio</h2>
        ...
        <div class="grid gap-4 md:grid-cols-2">
            <div class="rounded-3xl border border-white/10 bg-[#0D0C14] p-5">
                <h3 class="mb-3 text-base font-semibold">Offers</h3>
                <?php if ($offers): ?>
            ...
            <div class="rounded-3xl border border-white/10 bg-[#0D0C14] p-5">
                <h3 class="mb-3 text-base font-semibold">Wants</h3>
                <?php if ($wants): ?>
                    <ul class="space-y-2 text-gray-300">
    ...
    <aside class="space-y-6 rounded-3xl border border-white/10 bg-[#13121A]/90 p-4 shadow-lg shadow-black/20">
        ...
        <?php endif; ?>
        <div class="rounded-3xl border border-white/10 bg-[#0D0C14] p-5">
            <h3 class="mb-3 text-base font-semibold">Quick actions</h3>
